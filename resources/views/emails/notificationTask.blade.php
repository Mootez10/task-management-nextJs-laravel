...
<head>
    ...
    <title>Task {{ ucfirst($action) }}</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        ...
        <div class="email-header">
            <h1>Task {{ ucfirst($action) }}</h1>
        </div>

        <!-- Content -->
        <div class="email-content">
            <h2>Hi,</h2>
            <p>A task has been <strong>{{ $action }}</strong> in your task management system. Below are the details of the task:</p>
            ...
            <br>
            <a href="{{ url('/tasks/' . $task->id) }}" class="button">View Task Details</a>
