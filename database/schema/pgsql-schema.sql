...
CREATE TABLE public.sub_tasks (
    ...
    updated_at timestamp(0) without time zone,
    due_date date,
    CONSTRAINT sub_tasks_status_check CHECK (((status)::text = ANY ((ARRAY['pending'::character varying, 'done'::character varying, 'canceled'::character varying])::text[])))
);
...
CREATE TABLE public.tasks (
    ...
    updated_at timestamp(0) without time zone,
    due_date date,
    CONSTRAINT tasks_status_check CHECK (((status)::text = ANY ((ARRAY['pending'::character varying, 'done'::character varying, 'canceled'::character varying])::text[])))
);
...
--
-- Name: sub_tasks sub_tasks_task_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sub_tasks
    ADD CONSTRAINT sub_tasks_task_id_foreign FOREIGN KEY (task_id) REFERENCES public.tasks(id) ON DELETE CASCADE;
...
4	2024_09_19_160801_create_personal_access_tokens_table	1
5	2024_09_20_014143_create_tasks_table	1
6	2024_09_20_125333_create_sub_tasks_table	1
7	2024_09_24_203352_add_due_date_to_tasks_table	2
8	2024_09_26_193015_add_due_date_to_subtasks_table	3
\.
